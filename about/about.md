...
1. Тренировки по алгоритмам 7.0 (2025 год весна)

   - Лекции
   - Задачи и их разбор

2. Тренировки по алгоритмам 8.0 (2025 год осень)
    - Лекции
   - Задачи и их разбор

# Лекции и задачи тренировки 7.0

- [x] Лекция 1: «Жадный алгоритм и задача о рюкзаке»: [Youtube](https://youtube.com/live/CgHXYmhTbSw?feature=share)
   - [x] Домашнее задание 1: [Яндекс.Контест](https://contest.yandex.ru/contest/74964/enter)

- [x] Лекция 2: «Префиксные суммы, разреженная таблица, дерево отрезков»: [Youtube](https://youtube.com/live/j-TMzZzQTAU?feature=share)
   - [x] Домашнее задание 2: [Яндекс.Контест](https://contest.yandex.ru/contest/74966/enter)

- [x] Лекция 3: «Битовые операции, исправляющие коды Хэмминга, сжатие данных (алгоритм Лемпела-Зива)»: [Youtube](https://youtube.com/live/QV6vhMsZ8Q4?feature=share)
  - [x] Домашнее задание 3: [Яндекс.Контест](https://contest.yandex.ru/contest/74967)

- [x] Лекция 4: «Ссылочные типы данных, двусвязные списки, B‑деревья»: [Youtube](https://youtube.com/live/wzvhQY6W5AA?feature=share)
